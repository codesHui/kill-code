package com.imi.controllers.bjs;
 ...
 */
@Controller
@RequestMapping(value={"/bjsAdmin"})
public class BjsController implements IUserAware {
	private static final Logger logger = Logger.getLogger(BjsController.class);
	...
	public String modifyPassword_init(HttpServletRequest request){
		...
		return "bjsAdmin_modifyPassword";
	}
	...
	public String product_list(Model model,@ModelAttribute(value="productInfo")ProductInfo productInfo,HttpServletResponse response)
	{
		...
		return "product_bjs/product_list";
	}
...
/*		ProductInfo productInfo = new ProductInfo();
		...
		return "product_bjs/product_detail";
	}
	...
	public String list(@ModelAttribute(value="productInfo")ProductInfo productInfo,HttpServletRequest request,HttpServletResponse response){
		...
		return "complaints_bjs/complaints_list";
	}
	 ...
	 * @return
	 */
	@RequestMapping(value = {"/bjsAdmin_complain_detail"}, method = RequestMethod.GET)
...
/*			Product product = new Product();
		...
		return "complaints_bjs/complaints_detail";
	}
	...
	public String update(@ModelAttribute(value="Complaints")Complaints complaints,HttpServletRequest request,HttpServletResponse response){
		...
		if(token(token, request)){
			return "redirect:/bjsAdmin/complaints/list ";
		}
		String productNO = request.getParameter("productNO");
		// 无理0   有理1
		...
		return "redirect:/bjsAdmin/complaints_list ";
	}
	...
	public String veritys_list(@ModelAttribute(value="productInfo")ProductInfo productInfo,HttpServletRequest request,HttpServletResponse response){
		...
		return "verifys_bjs/verifys_list";
	}
	 ...
	 * @return
	 */
	@RequestMapping(value = {"/bjsAdmin_verifys_detail"}, method = RequestMethod.GET)
...
/*			Product product = new Product();
		...
		return "verifys_bjs/verifys_detail";
	}
