...
@Controller(value = "bjsAdminReportController")
@RequestMapping(value = { "/bjsAdmin/report" })
public class ReportController {

	private static final Logger logger = Logger
			.getLogger(VerifysController.class);
	@Resource
