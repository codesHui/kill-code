 ...
 * 最后修正：2009-12-18
 **/
//var IMAGESPATH ="../resources/images/"; //图片路径配置
...
Dialog.prototype.create = function () {
    ...
    var html = '\
  <table id="_DialogTable_' + this.ID + '" width="' + (this.Width + 26) + '" cellspacing="0" cellpadding="0" border="0" onselectstart="return true;" style="-moz-user-select: none; font-size:12px; line-height:1.4;">\
